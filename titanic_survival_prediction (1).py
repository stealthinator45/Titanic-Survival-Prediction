...
Original file is located at
    https://colab.research.google.com/drive/1vOnzCDe96tnHXoQsq0UavovxqX7slnu_
...
ngrok.set_auth_token("2dGdfXLj8tqI3doWwnoIatmxJUe_63R9s7FJFkmEvkkfaw5v")

#running flask app
os.system("nohup python -m flask run --no-reload &")

#opening ngrok tunnel to the flask app using htpp protocol
